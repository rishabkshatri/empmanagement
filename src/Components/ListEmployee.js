...
class ListEmployee extends Component {
    ...
    componentDidMount = () => {//life cycle function for the mounting phase
        ...
        return (
            <div style={divStyle}>
                <Table responsive>
                    <thead>
                        <tr bgcolor="Black">
                            <th bgcolor="White">EMPCODE</th>
                            <th bgcolor="White">FIRST NAME</th>
                            <th bgcolor="White">LAST NAME</th>
                            <th bgcolor="White">EMAIL-ID</th>
                            <th bgcolor="White">PHONE NO</th>
                            <th bgcolor="White">EDIT DATA</th>
                            <th bgcolor="White">DELETE DATA</th>
                        </tr>
                    </thead>
                    <tbody>
                        {
